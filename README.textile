...
And sent a message with the string "World" in the body, and a header "dayOrNight" with value "day", to this route
:
<code>
...
You could for example use SpEL as a predicate inside a [Message Filter] in XML
