...
public class SpelExpression extends ExpressionSupport {
    ...
    public SpelExpression(Object language, String expressionString, Class<?> type) {
    ...
    public static SpelExpression spel(String expression) {
        return new SpelExpression(new SpelLanguage(), expression, Object.class);
    }
    ...
    public String toString() {
        return "SpelExpression [expressionString=" + expressionString + "]";
    }
}
